...
public class ActualizarHorarioProfesorServicio {
    ...
    public ActualizarHorarioProfesorServicio(HorariosProfesorRepositorio horariosProfesorRepositorio, ProfesorDAO profesorDAO) {
    ...
    public void ejecutar(HorariosProfesor horariosProfesor) {
        ...
        this.horariosProfesorRepositorio.actualizar(horariosProfesor);
    }
