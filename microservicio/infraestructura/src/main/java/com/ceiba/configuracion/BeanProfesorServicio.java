...
public class BeanProfesorServicio {
    ...
    @Bean
    public ActualizarProfesorServicio actualizarProfesorServicio(ProfesorRepositorio profesorRepositorio) {
        return new ActualizarProfesorServicio(profesorRepositorio);
    }
}
