...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ExcepcionFechaEnPasado.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ExcepcionDatoNoEncontrado.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(EmptyResultDataAccessException.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(NumberFormatException.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(InvalidDataAccessApiUsageException.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
